...
ui.layout(
    <vertical gravity='center_vertical'>
        ...
        <button id='an1' style="Widget.AppCompat.Button.Colored" text="7KK刷新二维码" />
          <horizontal>
...
var 数据1 = [
    ['https://77k-com.songwhen.com', 'https://77k-com.songwhen.com/'],
    ['web', 'https://77k-com.songwhen.com', 'https://77k-com.songwhen.com/'],
    ['web', '77k-com.songwhen.com', 'https://77k-com.songwhen.com', 'https://77k-com.songwhen.com/']
];
p1.fenpei(tou, 代码1, 数据1)
//log(p1)
//结束配置(配置了一个二维码的信息，想继续添加可以以上代码为准继续添加)
var 配置url = [new URL('https://77k-com.songwhen.com/api/client/member/isLogin', 'https://77k-com.songwhen.com/api/client/member/login', 'https://77k-com.songwhen.com/api/client/member/isLogin')] //配置url
//
var gonmgneng = {
    ...
    xintiao: function(cookie, token, n) { //3
            let url = 'https://77k-com.songwhen.com/api/client/member/isLogin'
            for (var i = 0; i < n; i++) {
                ui.post(() => {
                ...
                ret = http.post(url, {}, {
                    headers: {
                        "device-type": "web",
                        "cookie": cookie + token,
                        "origin": "https://77k-com.songwhen.com",
                        "referer": "https://77k-com.songwhen.com/",
                        "token": token,
        ...
        qiandao: function(cookie, token) {
            let url = 'https://77k-com.songwhen.com/api/client/member/checkIn'
            let ret = http.get(url, {
                headers: {
                    "device-type": "web",
                    "authority": ".com",
                    "cookie": cookie + token,
                    "origin": "https:77k-com.songwhen.com//com",
                    "referer": "https://77k-com.songwhen.com/",
                    "token": token,
                    "X-Requested-With": "mark.via",
                    "User-Agent": bs
